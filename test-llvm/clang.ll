...
define dso_local i32 @main() #0 !dbg !10 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0)), !dbg !15
  ret i32 0, !dbg !16
}
...
!1 = !DIFile(filename: "simple.c", directory: "/home/bruneo/g/superc/test-llvm", checksumkind: CSK_MD5, checksum: "50c0b6f04caed4ba07c9368dffdb54e9")
...
!14 = !{}
!15 = !DILocation(line: 4, column: 2, scope: !10)
!16 = !DILocation(line: 5, column: 2, scope: !10)
